              ...
              <div className="grid gap-6">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Upload images for your restaurant profile</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-4">
                        <div className="relative h-20 w-20 overflow-hidden rounded-md border">
                          <Image
                            src={formData.logo || "/placeholder.svg?height=80&width=80"}
                            alt="Restaurant logo"
                            width={80}
                            height={80}
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative h-40 w-full overflow-hidden rounded-md border">
                        <Image
                          src={formData.banner || "/placeholder.svg?height=160&width=400"}
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Switch checked={formData.isOpen} onCheckedChange={handleSwitchChange} disabled={!isEditing} />
                  ...
                  {formData.businessHours.map((day, index) => (
                    <div
                      key={day.day}
                      className="grid grid-cols-1 sm:grid-cols-3 items-center gap-2 sm:gap-4 mb-3 sm:mb-0"
                    >
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    <span>Delivery Radius: {formData.deliveryRadius} miles</span>
              ...
              <CardFooter>
                <Button className="ml-auto" disabled={!isEditing} onClick={handleSave}>
