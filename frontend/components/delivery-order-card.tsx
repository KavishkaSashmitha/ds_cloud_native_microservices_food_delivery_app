...
export function DeliveryOrderCard({ order, showActions = true }: DeliveryOrderCardProps) {
    ...
    <Card>
      ...
      {showActions && (
        <CardFooter className="flex justify-end border-t p-4">
          <Button onClick={handleAcceptOrder} className="bg-orange-500 hover:bg-orange-600" disabled={isLoading}>
